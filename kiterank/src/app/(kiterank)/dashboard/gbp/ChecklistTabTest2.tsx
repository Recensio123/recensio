...
import { KategoriPunkt } from './KategoriPunkt'
      ...
      {visibleGroups.map(group => (
        <div key={group.id} className="space-y-2">
          ...
          <div className="bg-navy-800 rounded-xl border border-navy-700 divide-y divide-navy-700">
            {/* The profile's primary category — the field that decides which
                category searches they can appear for at all. Shown first in
                the highest-impact group, and silent when we cannot confirm it. */}
            {group.id === 'impact' && plan === 'testbok2' && <KategoriPunkt />}
