...
export default async function DashboardPage() {
  ...
  const snapshot     = VISA_EXEMPEL ? null : snapshotResult.data
  const prevSnapshot = VISA_EXEMPEL ? null : prevSnapshotResult.data
  const scQueries    = VISA_EXEMPEL ? null : scQueriesResult.data
  ...
  return (
    <StartpageSwitch companyName={company?.name ?? 'Your business'}>
