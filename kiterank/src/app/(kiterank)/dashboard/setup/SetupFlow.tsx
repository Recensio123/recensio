...
import { SALON_TEMPLATES } from '@/lib/templates'
...
import { AboutFields, type AboutBusiness } from '@/app/(kiterank)/onboarding/AboutFields'
              ...
              <div className="bg-navy-800 rounded-xl border border-navy-700 p-4">
                ...
                <ul className="space-y-1.5">
                  {[
                    ...
                    ...[konverteringsOrd(plan, lang).kanalRad],
                  ].map((line, i) => (
