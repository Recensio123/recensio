...
export const MOCK_ACTIONS: (Action & { titleSv: string; descriptionSv: string; impactSv: string; timeEstimateSv: string })[] = [
  ...
  },
  {
    priority:     3,
    category:     'Ads',
    /* Ordet är medvetet neutralt. Åtgärderna är en delad lista utan tillgång
       till vilket upplägg kunden kör, och "bokning" här blev fel för den
       hantverkare som aldrig har en tidbok. "Kund" är sant för båda. */
    title:        'Pause the ad keywords that bring no customers',
    description:  'Two keywords have spent over 700 kr combined without bringing a single customer. Open the Ads page, find them in the list, and pause them.',
    impact:       'Stops the waste immediately and moves your budget to the searches that actually bring customers.',
    timeEstimate: '15 minutes',
    titleSv:        'Pausa annonssökorden som inte ger kunder',
    descriptionSv:  'Två sökord har kostat över 700 kr tillsammans utan att ge en enda kund. Öppna Annonser, hitta dem i listan och pausa dem.',
  ...
  },
  {
    ...
    description:  'People search for a treatment you offer 1 000+ times a month, but you have no page for it and sit beyond position 30. Create a dedicated page with a clear headline, description, prices, and a clear way to get in touch or book.',
    impact:       'A dedicated page can reach page 1 within 2–3 months, capturing customers who currently go to competitors.',
    timeEstimate: '2–3 hours',
    titleSv:        'Skapa en sida för din mest sökta saknade behandling',
    descriptionSv:  'Folk söker på en behandling du erbjuder över 1 000 gånger i månaden, men du har ingen sida för den och ligger bortom plats 30. Skapa en egen sida med tydlig rubrik, beskrivning, priser och en tydlig väg vidare för den som vill boka eller höra av sig.',
    impactSv:       'En egen sida kan nå sida 1 inom 2–3 månader och fånga kunder som idag går till konkurrenterna.',
