...
const T = {
  sv: {
    ...
    typePlaceholder: 't.ex. Frisörsalong, Nagelsalong, Massör',
    ...
    locationSub:     'Hjälper oss föreslå sökord nära dig — t.ex. "frisör hägersten" i stället för "frisör stockholm"',
  ...
  en: {
    ...
    namePlaceholder: 'e.g. Studio Söder AB',
    typeLabel:       'Business type',
    typePlaceholder: 'e.g. Hair salon, Nail salon, Massage therapist',
    ...
    locationSub:     'Helps suggest hyper-local keywords — e.g. "hair salon södermalm" instead of "hair salon stockholm"',
