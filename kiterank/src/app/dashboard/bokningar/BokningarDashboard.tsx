...
type Tab = 'kalender' | 'lista' | 'personal' | 'sms' | 'installningar' | 'konton'
...
const TABS_BY_ROLE: Record<Role, Tab[]> = {
  admin:  ['kalender', 'lista', 'personal', 'sms', 'installningar', 'konton'],
...
const T = {
  sv: {
    ...
    tabs:        { kalender: 'Kalender', lista: 'Lista', personal: 'Personal', sms: 'SMS', installningar: 'Inställningar', konton: 'Konton' } as Record<Tab, string>,
    statToday:   'Idag',
  ...
  en: {
    ...
    tabs:        { kalender: 'Calendar', lista: 'List', personal: 'Staff', sms: 'SMS', installningar: 'Settings', konton: 'Accounts' } as Record<Tab, string>,
    statToday:   'Today',
    statWeek:    'This week',
