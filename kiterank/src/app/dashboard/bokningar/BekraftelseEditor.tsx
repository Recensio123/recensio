...
/* The pieces of the booking a salon can weave into their wording. Filled with
 * the real values on the receipt; the preview uses an example visit. */
...
export function previewOf(text: string): string {
  let out = text
  for (const [k, v] of Object.entries(PREVIEW_VALUES)) out = out.replaceAll(k, v)
  return out
}
