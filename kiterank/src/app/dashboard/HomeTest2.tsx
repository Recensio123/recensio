...
// Mock values — same figures as before (FORCE_MOCK build)
const MOCK_DATA = {
  reviewCount:       47,
  responded:         19,
  newReviews:        3,
...
const T = {
  sv: {
    ...
    headlineKr:      ' — värda ca 16 800 kr i bokningar',
    ...
    wowBooking:      'Bokningar från annonser',
    channels: [
  ...
  en: {
    ...
    headlineKr:      ' — worth ca 16 800 kr in bookings',
    ...
    <div className="px-4 sm:px-8 py-6 space-y-6">
      ...
      <div className="bg-navy-800 rounded-xl border border-navy-700 px-5 sm:px-6 py-5">
        ...
        <p className="text-white text-xl sm:text-2xl font-bold leading-snug">
          {t.headline}
          {bookingMode && <span className="text-green-400">{t.headlineKr}</span>}
        </p>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {t.wow.map((w, i) => {
            ...
            const label = bookingMode && i === 2 ? t.wowBooking : w.label
