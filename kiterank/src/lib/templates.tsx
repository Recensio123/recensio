...
const salon: Template[] = [
  ...
  /* Nordic (split) is retired from the salon lineup. Its hero put a picture
     beside the heading, and it was the only salon design that did — one
     design's exception is not worth a control that appears and disappears
     from the panel depending on which card the customer picked. The layout
     itself lives on for the trades that still list it. */
]
